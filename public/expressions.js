...
function pingMachine() {
    ...
    $.ajax('/', {
        success: function () {
            activateMachine();
            if ($('#expression-route').attr('src') === "https://content.codecademy.com/courses/learn-express-routes/expression-route-inactive.svg") {
                $('#expression-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expression-route-active.svg');
                $('#expressions-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-active.svg');
                activateExpressions();
            }
        },
        error: function (xhr) {
